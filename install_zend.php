...
if (!is_dir($install_path.'/.zend/')) {
    ...
    exec("ln -s ./.zend/library/Zend/ {$install_path}/Zend");
    echo "Done!\n";
}
...
if (!empty($files)) {
    ...
    $mapping = '<?php' . "\n/* Auto generated by https://github.com/falexandrou/fuelphp-zend */\nAutoloader::add_classes(array(\n";
    ...
    $contents = "Zend\n.zend/\n";
    $done = file_put_contents($install_path.'/.gitignore', $contents);
    echo $done ? ".gitignore created successfully!\n" : ".gitignore not created. Permissions maybe?";
    exit;
}
